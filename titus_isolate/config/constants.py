...
DEFAULT_BURST_CORE_COLLOC_USAGE_THRESH = 0.5

WEIGHT_CPU_USE_BURST = 'TITUS_ISOLATE_WEIGHT_CPU_USE_BURST'
DEFAULT_WEIGHT_CPU_USE_BURST = 1.0

FORECAST_IP_REBALANCE_FREQ = 'FORECAST_IP_REBALANCE_FREQ'
DEFAULT_FORECAST_IP_REBALANCE_FREQ = 10
