...
# New Remote Allocator
NEW_REMOTE_ALLOC_ENDPOINT = 'TITUS_ISOLATE_NEW_REMOTE_ALLOCATOR_ENDPOINT'
NEW_REMOTE_ALLOC_CLIENT_CALL_TIMEOUT_MS = 'TITUS_ISOLATE_NEW_REMOTE_ALLOCATOR_CLIENT_CALL_TIMEOUT_MS'
NEW_REMOTE_ALLOC_DEFAULT_CLIENT_CALL_TIMEOUT_MS = 500

# Fallback
FALLBACK_QUEUE_DEPTH = 'TITUS_ISOLATE_FALLBACK_QUEUE_DEPTH'
DEFAULT_FALLBACK_QUEUE_DEPTH = 5
...
CPU_ALLOCATORS = [IP, FORECAST_CPU_IP, GREEDY, NAIVE, NOOP, NOOP_RESET, REMOTE, NEW_REMOTE]
