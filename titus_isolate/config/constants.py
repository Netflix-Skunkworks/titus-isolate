...
# Shadow loaded cores
SYS_CORE_IDS = 'TITUS_ISOLATE_SYS_CORE_IDS'
SYS_CORES_USAGE = 'TITUS_ISOLATE_SYS_CORES_USAGE'
SYS_CORES_HARD_ISOLATE = 'TITUS_ISOLATE_SYS_CORES_HARD_ISOLATE'
