...
WORKLOAD_JSON_DURATION_KEY = 'titus.agent.runtimePredictionSec'
...
WORKLOAD_JSON_OPPORTUNISTIC_CPU_KEY = 'titus.agent.opportunisticCpu'
...
WORKLOAD_JSON_LAUNCH_TIME_KEY = 'launchTimeUnixSec'
